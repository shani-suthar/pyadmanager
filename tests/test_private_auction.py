...
class TestListPrivateAuctions:
    def test_builds_endpoint_and_filter(self, fake_http_client):
        ...
        client.list(display_name="Q1 Auction", archived=False)
    ...
    def test_private_auction_id_is_resolved_to_full_path(self, fake_http_client):
        ...
        client.list(private_auction_id=456)
    ...
    def test_display_name_and_description_are_quoted(self, fake_http_client):
        ...
        client.list(display_name="Q1 Auction", description="Quarterly deal")
    ...
    def test_create_time_and_update_time_are_quoted_rfc3339(self, fake_http_client):
        ...
        client.list(create_time=dt, update_time=(dt, "GT_EQ"))
    ...
    def test_partial_fields_are_joined_in_field_order_skipping_unset(self, fake_http_client):
        ...
        client.list(description="Quarterly deal", archived=True)
