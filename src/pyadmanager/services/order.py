...
class OrderClient:
    ...
    def list(
        ...
        filter_list = [
            GAMRestFilters.id_based_filter("name", order_id_str),
            GAMRestFilters.text_filter("displayName", display_name),
            GAMRestFilters.id_based_filter("advertiser", advertiser_id_str),
            GAMRestFilters.id_based_filter("agency", agency_id_str),
            GAMRestFilters.id_based_filter("trafficker", trafficker_id_str),
            GAMRestFilters.id_based_filter("salesperson", salesperson_id_str),
            GAMRestFilters.text_filter("currencyCode", currency_code),
            ...
            GAMRestFilters.boolean_filter("programmatic", programmatic),
            GAMRestFilters.boolean_filter("archived", archived),
            GAMRestFilters.text_filter("externalOrderId", external_order_id),
            GAMRestFilters.text_filter("poNumber", po_number),
        ]
